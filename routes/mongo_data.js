...
// I need to create something with Socket.io. Basic idea is to send the data everytime the mongodb changes
// Let me choose a data to collect  

// So I can choose a bunch of students and then stream the data to the front end. 
// Frontend can first be a text box
...
// I now understand how to read this code. 
// So the studentStatusNS or io is the namespace
// when a socket connects to the namespace, then I need to specify how I want to the specific socket to work.
// I have a better idea. With the iteration, I can utilize the room in this process. Each route has its own room. The room number will be autogenerated and carried 
// the socket will thhen join the room. the data will be broadcasted to the room
...
function getTopSongRank(db){
    ...
    // while(latestPositionArray.length !== ids.length){
